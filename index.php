...
if(isset($_POST['ingresar'])){
	$usuario = mysqli_real_escape_string($conexion,$_POST['user']); //evitar inyecciones sql
	$password = mysqli_real_escape_string($conexion,$_POST['pass']);
	$password_encriptada = sha1("$password");
	$sql="SELECT idusuario FROM usuario WHERE usuario = '$usuario' AND password = '$password_encriptada'";
	...
	if($rows > 0){
		...
		echo "<script>
			alert('El usuario o password incorrecto');
...
if(isset($_POST["registrar"])){
	$nombre = mysqli_real_escape_string($conexion,$_POST['nombre']); //evitar inyecciones sql
	$correo = mysqli_real_escape_string($conexion,$_POST['correo']);
	$usuario = mysqli_real_escape_string($conexion,$_POST['user']);
	$password = mysqli_real_escape_string($conexion,$_POST['pass']);
	//$password2 = mysqli_real_escape_string($conexion,$_POST["passr"]);
	$password_encriptada = sha1("$password");
	$sqluser = "SELECT idusuario from usuario where usuario = '$usuario'";
	$resultado_user = $conexion->query($sqluser);
	...
	if($filas>0){
		...
		$resultado_usuario = $conexion->query($sqlusuario);
